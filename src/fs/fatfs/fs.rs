...
use core::{char, cmp, u32};

use crate::fs::fatfs::boot_sector::{format_boot_sector, BiosParameterBlock, BootSector};
use crate::fs::fatfs::dir::{Dir, DirRawStream};
use crate::fs::fatfs::dir_entry::{DirFileEntryData, FileAttributes, SFN_PADDING, SFN_SIZE};
use crate::fs::fatfs::error::Error;
use crate::fs::fatfs::file::File;
use crate::fs::fatfs::io::{self, IoBase, Read, ReadLeExt, Seek, SeekFrom, Write, WriteLeExt};
use crate::fs::fatfs::table::{
	alloc_cluster, count_free_clusters, format_fat, read_fat_flags, ClusterIterator,
	RESERVED_FAT_ENTRIES,
};
use crate::fs::fatfs::time::{DefaultTimeProvider, TimeProvider};
